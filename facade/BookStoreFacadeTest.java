...
public class BookStoreFacadeTest extends AbstractClientTest {
	...
	protected BookstoreFacade createFacade() {
		DefaultBookstoreFacade defaultBookstoreFacade = new DefaultBookstoreFacade();
		defaultBookstoreFacade.setWharehouseService(warehouseService);
		defaultBookstoreFacade.setBookDBService(bookService);
		defaultBookstoreFacade.setOrderingService(orderingService);
		defaultBookstoreFacade.setCustomerDBService(customerService);
		defaultBookstoreFacade.setCustomerNotificationService(customerNotificationService);
		
		return defaultBookstoreFacade;
	}
}
